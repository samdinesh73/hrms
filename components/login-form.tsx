...
export function LoginForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      document.cookie = `authToken=${data.data.token}; path=/; max-age=86400; SameSite=Strict`
          ...
          <form className="p-6 md:p-8" onSubmit={handleSubmit}>
            <FieldGroup>
              ...
              <div className="rounded-md bg-blue-50 p-3 text-xs text-blue-700 border border-blue-200">
                ...
                <p>👤 Employee: emp@example.com / password123</p>
                <p>👔 Manager: mgr@example.com / password123</p>
              ...
              <FieldDescription className="text-center">
                Don&apos;t have an account? <a href="#" className="hover:underline">Contact admin</a>
              </FieldDescription>
            </FieldGroup>
          </form>
